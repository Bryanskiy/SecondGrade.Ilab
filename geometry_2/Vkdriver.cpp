...
void Vkdriver::run(const std::vector<Vertex>& vertex_array) {
...
void Vkdriver::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mode) {
	auto app = static_cast<Vkdriver*>(glfwGetWindowUserPointer(window));
...
void Vkdriver::createUniformBuffers() {
