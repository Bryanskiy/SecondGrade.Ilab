...
#line 692 "parser.tab.cc"
  ...
  case 7: // expr: vertex "--" vertex "," edge
#line 38 "parser.y"
                                                                {
                                                                    driver->push(yystack_[4].value.as < size_t > (), yystack_[2].value.as < size_t > (), yystack_[0].value.as < size_t > ());
                                                                }
...
#line 716 "parser.tab.cc"
  ...
  parser::symbol_name (symbol_kind_type yysymbol)
  {
    ...
    {
    "END_OF_FILE", "error", "invalid token", "INTEGER", "--", ",", "\\n",
  "$accept", "program", "line", "expr", "vertex", "edge", YY_NULLPTR
    };
