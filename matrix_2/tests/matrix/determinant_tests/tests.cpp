...
matrix::matrix_t<long double> generate_orthogonal_matrix(std::size_t size) {
    ...
    for(std::size_t i = 0; i < size - 1; i += 2) {
        long double angle = dis(gen);
        long double sin = std::sin(angle);
...
void test_random_2_runner() {
    {
        char name[] = "tests/matrix/determinant_tests/cases/case_0.txt";
        test_random_2(name, 42);
    }

    {
        char name[] = "tests/matrix/determinant_tests/cases/case_1.txt";
        test_random_2(name, 126);
    }

    {
        char name[] = "tests/matrix/determinant_tests/cases/case_2.txt";
        test_random_2(name, 42);
    }

    {
        char name[] = "tests/matrix/determinant_tests/cases/case_3.txt";
        test_random_2(name, 1);
    }

    {
        char name[] = "tests/matrix/determinant_tests/cases/case_4.txt";
        test_random_2(name, 42);
    }
}
