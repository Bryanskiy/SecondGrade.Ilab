...
#line 727 "parser.tab.cc"
  ...
  case 7: // expr: vertex "--" vertex "," resist ";" voltage
#line 44 "parser.y"
                                                                {
                                                                    driver->push(yystack_[6].value.as < size_t > (), yystack_[4].value.as < size_t > (), yystack_[2].value.as < float > (), yystack_[0].value.as < float > ());
                                                                }
